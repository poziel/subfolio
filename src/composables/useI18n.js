...
const messages = {
  en: {
    ...
    expenseForm: {
      ...
      servicePresetPlaceholder: 'Choose a known service',
    ...
    connect: {
      ...
      signInBody: 'Use the temporary account form while hosted authentication is being built.',
      email: 'Email',
      password: 'Password',
      emailPlaceholder: 'you@example.com (optional)',
      passwordPlaceholder: 'Optional for now',
      signIn: 'Continue',
      temporaryAccess: 'Email and password are optional for now. Continuing opens the app with the managed PocketBase backend.',
      accountUnavailable: 'Account sign-in is temporary while hosted authentication is being built.',
  ...
  fr: {
    ...
    expenseForm: {
      ...
      servicePresetPlaceholder: 'Choisir un service connu',
    ...
    connect: {
      ...
      signInBody: 'Utilisez le formulaire de compte temporaire pendant la construction de l’authentification hébergée.',
      email: 'Courriel',
      password: 'Mot de passe',
      emailPlaceholder: 'vous@exemple.com (optionnel)',
      passwordPlaceholder: 'Optionnel pour le moment',
      signIn: 'Continuer',
      temporaryAccess: 'Le courriel et le mot de passe sont optionnels pour le moment. Continuer ouvre l’app avec le backend PocketBase géré.',
      accountUnavailable: 'La connexion par compte est temporaire pendant la construction de l’authentification hébergée.',
