...
const messages = {
  en: {
    ...
    confirm: {
      ...
      deleteExpenseMessage: 'This will permanently delete {name}. This action cannot be undone.',
      keepExpense: 'No, keep it',
      deleteExpense: 'Yes, delete'
    },
    toast: {
      expenseAdded: 'Expense added',
      expenseAddedDetail: '{name} was added.',
      expenseUpdated: 'Expense updated',
      expenseUpdatedDetail: '{name} was updated.',
      expenseDeleted: 'Expense deleted',
      expenseDeletedDetail: '{name} was deleted.'
    },
    frequencies: {
      once: 'Once',
      yearly: 'Yearly',
    ...
    expenseDetail: {
      ...
      intro: 'Inspect payment history, corrections, and price changes over time.',
      back: 'Expenses',
      close: 'Close expense detail',
      notFound: 'This expense could not be found.',
      coreInfo: 'Core information',
      currentPrice: 'Current price',
      startedPaying: 'Started paying',
      inactive: 'Inactive',
      historyRecords: 'History records',
      priceChanges: 'Price changes',
      totalPaid: 'Total paid',
      pricePoints: 'Prices paid',
      serviceLink: 'URL',
      effectivePriceTitle: 'Effective price change',
      effectivePriceSubtitle: 'Update records from a selected date and set the current recurring price.',
      effectiveDate: 'Effective date',
      newAmount: 'New amount',
      applyEffectiveChange: 'Apply change',
      historyTitle: 'Payment history',
      historySubtitle: 'Started on {date}',
      loadingHistory: 'Loading payment history...',
      emptyHistory: 'No payment history exists for this expense yet.',
      paidDate: 'Paid date',
      ...
      scheduled: 'Scheduled',
      effectiveDetail: 'Changed from {amount} starting {date}.',
      oneTimeDetail: 'Changed from {amount} for this payment only.',
      paidDateDetail: 'Paid date corrected from {date}.',
      scheduledDetail: 'Generated from the recurrence schedule.',
      editPayment: 'Edit payment',
      editPaymentTitle: 'Edit payment history',
      editPaymentSubtitle: 'Payment scheduled for {date}.',
      applyTo: 'Apply to',
      singlePayment: 'This payment only',
      thisAndLater: 'This and later payments',
  ...
  fr: {
    ...
    confirm: {
      ...
      deleteExpenseMessage: 'Cela supprimera définitivement {name}. Cette action est irréversible.',
      keepExpense: 'Non, conserver',
      deleteExpense: 'Oui, supprimer'
    },
    toast: {
      expenseAdded: 'Dépense ajoutée',
      expenseAddedDetail: '{name} a été ajoutée.',
      expenseUpdated: 'Dépense modifiée',
      expenseUpdatedDetail: '{name} a été modifiée.',
      expenseDeleted: 'Dépense supprimée',
      expenseDeletedDetail: '{name} a été supprimée.'
    },
    frequencies: {
      once: 'Une fois',
      yearly: 'Annuel',
    ...
    expenseDetail: {
      ...
      intro: 'Consultez l’historique des paiements, les corrections et les changements de prix.',
      back: 'Dépenses',
      close: 'Fermer le détail de la dépense',
      notFound: 'Cette dépense est introuvable.',
      coreInfo: 'Informations principales',
      currentPrice: 'Prix actuel',
      startedPaying: 'Début des paiements',
      inactive: 'Inactive',
      historyRecords: 'Entrées d’historique',
      priceChanges: 'Changements de prix',
      totalPaid: 'Total payé',
      pricePoints: 'Prix payés',
      serviceLink: 'URL',
      effectivePriceTitle: 'Changement de prix effectif',
      effectivePriceSubtitle: 'Mettre à jour les entrées depuis une date et le prix récurrent actuel.',
      effectiveDate: 'Date d’effet',
      newAmount: 'Nouveau montant',
      applyEffectiveChange: 'Appliquer',
      historyTitle: 'Historique des paiements',
      historySubtitle: 'Commencé le {date}',
      loadingHistory: 'Chargement de l’historique des paiements...',
      emptyHistory: 'Aucun historique de paiement n’existe encore pour cette dépense.',
      paidDate: 'Date payée',
      scheduledDate: 'Date prévue',
      actualPaidDate: 'Date payée',
      amountPaid: 'Montant payé',
      taxAmount: 'Montant de taxe',
      currency: 'Devise',
      change: 'Changement',
      details: 'Détails du paiement',
      effectiveFrom: 'Effectif depuis',
      oneTime: 'Changement ponctuel',
      manualCorrection: 'Correction manuelle',
      scheduled: 'Planifié',
      effectiveDetail: 'Changé depuis {amount} à partir du {date}.',
      oneTimeDetail: 'Changé depuis {amount} pour ce paiement seulement.',
      paidDateDetail: 'Date payée corrigée depuis le {date}.',
      scheduledDetail: 'Généré depuis le calendrier de récurrence.',
      editPayment: 'Modifier le paiement',
      editPaymentTitle: 'Modifier l’historique du paiement',
      editPaymentSubtitle: 'Paiement prévu le {date}.',
      applyTo: 'Appliquer à',
      singlePayment: 'Ce paiement seulement',
      thisAndLater: 'Ce paiement et les suivants',
